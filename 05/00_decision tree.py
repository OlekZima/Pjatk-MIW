...
X, y = make_moons(n_samples=10000, noise=0.4, random_state=42)  # Generuje zbiór danych z dwoma przeciwstawianymi kształtami
...
max_depths = [None, 3, 5, 10]  # Różne maksymalne głębokości drzewa

# Tworzenie subplotów przed iteracją
fig, axes = plt.subplots(4, 2, figsize=(12, 16))  # Tworzy subploty dla różnych kombinacji kryteriów i maksymalnych głębokości drzewa
