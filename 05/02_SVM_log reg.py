...
'''do uzupełnienia'''  # Inicjalizuje klasyfikator regresji logistycznej
'''do uzupełnienia'''  # Dopasowuje model do danych treningowych
'''do uzupełnienia'''  # Oblicza dokładność na danych treningowych
'''do uzupełnienia'''  # Oblicza dokładność na danych testowych

# Krok 4: Trenowanie klasyfikatora SVM default
'''do uzupełnienia'''  # Inicjalizuje klasyfikator SVM
'''do uzupełnienia'''  # Dopasowuje model do danych treningowych
'''do uzupełnienia'''  # Oblicza dokładność na danych treningowych
'''do uzupełnienia'''  # Oblicza dokładność na danych testowych
