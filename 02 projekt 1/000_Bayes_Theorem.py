...
# Dane wejściowe
p_choroba = 0.09  # P(x) Prawdopodobieństwo, że osoba ma chorobę
...
p_test_pozytywny = p_choroba * p_test_pozytywny_dla_choroby + p_brak_choroby * p_test_pozytywny_dla_braku_choroby
print(f"p_test_pozytywny={round(p_test_pozytywny,2)}")

# Prawdopodobieństwo, że osoba ma chorobę przy pozytywnym wyniku testu
p_choroba_przy_pozytywnym_tescie = p_choroba * p_test_pozytywny_dla_choroby / p_test_pozytywny
