...
# Inicjalizacja wektora a priori, każdy posiłek ma równą szansę na wybór.
...
for _ in range(10000):
    ...
    next_meal = np.random.choice(
        states, p=[transition_matrix[previous_meal][_] for _ in states]
    )
...
print(
    "Prawdopodobieństwo wystąpienia poszczególnych posiłków =", probability_meal_counts
)
# %%
