...
class NeuralNetworkRegression:
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.weights_input_hidden = '''do uzupełnienia'''
        self.weights_hidden_output = '''do uzupełnienia'''
        # Inicjalizacja biasów dla warstwy ukrytej i wyjściowej
        self.bias_hidden = '''do uzupełnienia'''
        self.bias_output = '''do uzupełnienia'''
    ...
    def forward(self, X):
        ...
        hidden_input = '''do uzupełnienia'''
        hidden_output = '''do uzupełnienia'''
        output_input = '''do uzupełnienia'''
        return '''do uzupełnienia'''
...
nn.train(X_train, y_train, epochs=epochs, learning_rate=learning_rate, reg_lambda=0.01)
...
plt.xlabel('X')
plt.ylabel('Y')
plt.title(f'Neurons={hidden_size}, Epochs={len(nn.history_r2)}, learn_r={learning_rate}')
plt.legend()
